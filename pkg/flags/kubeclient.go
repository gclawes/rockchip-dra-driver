...
// KubeClientConfig holds kubeconfig flags for in- or out-of-cluster clients.
...
// ClientSets is the set of Kubernetes clients used by the plugin.
type ClientSets struct {
	Core coreclientset.Interface
}

// Flags returns CLI flags for the kube client.
...
// NewClientSetConfig builds a REST config.
...
// NewClientSets builds the Kubernetes clients used by the plugin.
func (k *KubeClientConfig) NewClientSets() (ClientSets, error) {
	...
	return ClientSets{Core: coreclient}, nil
}
